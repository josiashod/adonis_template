...
export default class UpdateEmailConfirmationMailer extends BaseMailer {
  ...
  public async prepare(message: MessageContract) {
    ...
    const html = mjml(
      await View.render('emails/accounts/email-update-confirmation', {
        user: this.user,
        link,
        mailGreeting: $t('mail.greeting'),
        mailConfirmationBodyFirst: $t('mail.confimration.update.email.body.first',{appName: appName }),
