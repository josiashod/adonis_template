...
const driveConfig: DriveConfig = {
  /*
   ...
   |
   */
  disk: <never>Env.get('DRIVE_DISK', 'local'),
  ...
  disks: {
    ...
    local: {
      ...
      /*
       ...
       |
       */
      root: Application.makePath('storage/public/'),
    ...
    uploads: {
      driver: 'local',
      visibility: 'public',
      root: Application.makePath('storage/public/uploads'),
      serveFiles: true,
    ...
    users: {
      driver: 'local',
      visibility: 'public',
      root: Application.makePath('storage/public/uploads/users'),
      serveFiles: true,
      basePath: '/storage/uploads/users',
    },

    events: {
      driver: 'local',
      visibility: 'public',
      root: Application.makePath('storage/public/uploads/events'),
      serveFiles: true,
      basePath: '/storage/uploads/events',
    },
